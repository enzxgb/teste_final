...
-- Copiando estrutura para tabela sabor_do_brasil.avaliacoes
CREATE TABLE IF NOT EXISTS `avaliacoes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique` (`user_id`,`publicacao_id`),
  KEY `publicacao_id` (`publicacao_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela sabor_do_brasil.avaliacoes: ~0 rows (aproximadamente)
...
INSERT INTO `cache` (`key`, `value`, `expiration`) VALUES
	('laravel-cache-usuario02@gmail.com|127.0.0.1', 'i:1;', 1761746030),
	('laravel-cache-usuario02@gmail.com|127.0.0.1:timer', 'i:1761746030;', 1761746030);
...
<<<<<<< HEAD
-- Copiando dados para a tabela sabor_do_brasil.empresa: ~1sabor_do_brasil rows (aproximadamente)
=======
...
-- Copiando dados para a tabela sabor_do_brasil.comentarios: ~0 rows (aproximadamente)
...
>>>>>>> 9828b190 (Desenvolvendo Sistema de Comentários)
...
INSERT INTO `publicacao` (`id`, `foto`, `titulo_prato`, `local`, `cidade`, `empresa_id`, `createdAt`, `updatedAt`) VALUES
	...
	(2, 'publicacao03.png', 'Frango com batatas assadas', 'Nova Iguaçu', 'Rio de Janeiro-RJ', 1, '2023-05-22 09:13:55', '2023-02-22 09:15:55'),
	(3, 'publicacao02.png', 'Cuscuz Paulista', 'Ouro Preto', 'Minas Gerais-MG', 1, '2023-02-22 09:10:55', '2023-02-22 09:16:55');
...
-- Copiando dados para a tabela sabor_do_brasil.sessions: ~5 rows (aproximadamente)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('Oo5PdClEqesJVkUWRmDSmrg2B3tAABg7coVYT3HW', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoibXREWlBtaGJlV2dIeVlnenZKSzBCbk9Wc1pXdWVHUUloSGQwUnFMNiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fX0=', 1761768641);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `nickname`, `foto`) VALUES
	(1, 'Maria Maitê', 'usuario01@usuario.com', NULL, '$2y$12$/jYgXg7GVhiojjVZfkBlNOBV9UlWQettnCkSN6ZSRQykqwJee9Gl.', NULL, '2025-10-24 07:23:55', '2025-10-24 07:23:55', 'usuario_01', 'usuario_01.jpg'),
	(2, 'Lorena', 'usuario02@usuario.com', NULL, '$2y$12$PfDm99kiBDqYU64mktTat.9YlQHb5zLQ6tHXFxZ2N9eb7mKE/yyo.', NULL, '2025-10-25 05:57:30', '2025-10-25 05:57:30', 'usuario_02', 'usuario_02.jpg'),
	(3, 'Maria de Lurdes', 'usuario03@usuario.com', NULL, '$2y$12$jXReMAVFgqu1SmURNgH01OOhfGTEKSD1.bDtNioRTl5nu0r9O5WWS', NULL, '2025-10-25 06:56:48', '2025-10-25 06:56:48', 'usuario_03', 'usuario_03.jpg	');
